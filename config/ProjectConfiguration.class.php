...
class ProjectConfiguration extends sfProjectConfiguration
{
  public function setup()
  {
    ...
    $this->dispatcher->connect('a.getGlobalButtons', array('ProjectConfiguration', 'getGlobalButtons'));
    
    $this->dispatcher->connect('context.load_factories', array($this, 'detectSite'));
    
    //$this->dispatcher->connect('context.load_factories', array('ProjectConfiguration', 'testFunction'));
