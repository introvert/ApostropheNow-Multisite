...
<div class="a-ui a-admin-header">
	<h3 class="a-admin-title"><?php echo __('User list', array(), 'apostrophe') ?></h3>
...
<div class="a-ui a-admin-container <?php echo $sf_params->get('module') ?>">
	...
	<div class="a-admin-content main">
				  ...
				  <?php include_partial('aUserAdmin/filters', array('form' => $filters, 'configuration' => $configuration, 'filtersActive' => $filtersActive)) ?>
