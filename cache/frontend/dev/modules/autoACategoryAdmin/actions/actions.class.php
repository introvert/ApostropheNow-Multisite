...
require_once(dirname(__FILE__).'/../lib/BaseACategoryAdminGeneratorConfiguration.class.php');
require_once(dirname(__FILE__).'/../lib/BaseACategoryAdminGeneratorHelper.class.php');
 ...
 */
class autoACategoryAdminActions extends sfActions
{
  ...
  public function executeNew(sfWebRequest $request)
  {
    ...
    $this->a_category = $this->form->getObject();
  }
  ...
  {
    $this->a_category = $this->getRoute()->getObject();
    $this->form = $this->configuration->getForm($this->a_category);
  }
  ...
  public function executeBatch(sfWebRequest $request)
  {
    ...
    $validator = new sfValidatorDoctrineChoice(array('multiple' => true,  'model' => 'aCategory'));
    try
    {
      // validate ids
  ...
  {
    return $this->getUser()->getAttribute('aCategoryAdmin.filters', $this->configuration->getFilterDefaults(), 'admin_module');
  }

  protected function setFilters(array $filters)
  {
    return $this->getUser()->setAttribute('aCategoryAdmin.filters', $filters, 'admin_module');
  }

  protected function getPager()
  {
    $pager = $this->configuration->getPager('aCategory');
  ...
  {
    $this->getUser()->setAttribute('aCategoryAdmin.page', $page, 'admin_module');
  }

  protected function getPage()
  {
    return $this->getUser()->getAttribute('aCategoryAdmin.page', 1, 'admin_module');
  }
  ...
  {
    if (!is_null($sort = $this->getUser()->getAttribute('aCategoryAdmin.sort', null, 'admin_module')))
    {
      return $sort;
    }
    ...
    return $this->getUser()->getAttribute('aCategoryAdmin.sort', null, 'admin_module');
  }
  ...
  protected function setSort(array $sort)
  {
    ...
    $this->getUser()->setAttribute('aCategoryAdmin.sort', $sort, 'admin_module');
  }
}
