...
<div id="a-admin-filters-container" class="a-ui <?php echo $filtersActive ? 'a-active' : '' ?>">
	  ...
	  <form action="<?php echo url_for('a_site_admin_collection', array('action' => 'filter')) ?>" method="post" id="a-admin-filters-form">
	    ...
	    <div class="a-admin-filters-fields">
	        ...
	        <?php if ((isset($form[$name]) && $form[$name]->isHidden()) || (!isset($form[$name]) && $field->isReal())) continue ?>
	          ...
	          <?php include_partial('Site/filters_field', array(
	            'name'       => $name,
        ...
        <?php echo $form->renderHiddenFields() ?>
				<div class="a-form-row submit">
					<ul class="a-ui a-controls">
						...
						<li><?php echo link_to('<span class="icon"></span>'.a_('Reset'), 'a_site_admin_collection', array('action' => 'filter'), array('query_string' => '_reset', 'method' => 'post', 'class' => 'a-btn icon a-cancel')) ?></li>
					</ul>
				</div>
