...
require_once(dirname(__FILE__).'/../lib/BaseSiteGeneratorConfiguration.class.php');
require_once(dirname(__FILE__).'/../lib/BaseSiteGeneratorHelper.class.php');
 ...
 */
class autoSiteActions extends sfActions
{
  public function preExecute()
  {
    $this->configuration = new SiteGeneratorConfiguration();
    ...
    $this->helper = new SiteGeneratorHelper();
  ...
  public function executeEdit(sfWebRequest $request)
  {
    ...
    $this->form = $this->configuration->getForm($this->site);
  }
  ...
  public function executeBatch(sfWebRequest $request)
  {
    ...
    $validator = new sfValidatorDoctrineChoice(array('multiple' => true,  'model' => 'Site'));
    try
    {
      // validate ids
  ...
  protected function processForm(sfWebRequest $request, sfForm $form)
  {
    ...
    if ($form->isValid())
    {
      ...
      if ($request->hasParameter('_save_and_add'))
      {
        ...
        $this->redirect('@a_site_admin_new');
      }
      elseif ($request->hasParameter('_save'))
      {
        $this->redirect('@a_site_admin_edit?id='.$site->getId());
      }
  ...
  {
    return $this->getUser()->getAttribute('Site.filters', $this->configuration->getFilterDefaults(), 'admin_module');
  }

  protected function setFilters(array $filters)
  {
    return $this->getUser()->setAttribute('Site.filters', $filters, 'admin_module');
  }
  ...
  {
    $this->getUser()->setAttribute('Site.page', $page, 'admin_module');
  }

  protected function getPage()
  {
    return $this->getUser()->getAttribute('Site.page', 1, 'admin_module');
  }
  ...
  {
    if (!is_null($sort = $this->getUser()->getAttribute('Site.sort', null, 'admin_module')))
    {
      return $sort;
    }
    ...
    return $this->getUser()->getAttribute('Site.sort', null, 'admin_module');
  }
  ...
  protected function setSort(array $sort)
  {
    ...
    $this->getUser()->setAttribute('Site.sort', $sort, 'admin_module');
  }
}
