...
<div class="a-feedback-footer" id="a-feedback-footer">
	<?php echo a_js_button(a_('Submit a Bug Report'), array('a-feedback'), 'a-feedback-link') ?>
	...
	<?php if ($reportSubmittedBy = $sf_user->getFlash('reportSubmittedBy')): ?>
 	<div class="a-feedback-submitted"><span class="submitted-by"><?php echo $reportSubmittedBy ?></span>, thank you for submitting a bug report.</div>
	<?php endif ?>
</div>
